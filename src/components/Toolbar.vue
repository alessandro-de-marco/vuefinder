  ...
  <div class="border-neutral-300 flex justify-between items-center py-1 text-sm">
    <div class="flex text-center" v-if="!searchQuery.length">
      <div class="mx-1.5"
           ...
           @click="emit('vf-new-folder', selectedItems)"
      >
      ...
      <div class="mx-1.5"
           ...
           @click="emit('vf-new-file', selectedItems)">
        <svg xmlns="http://www.w3.org/2000/svg"
             class="h-6 w-6 md:h-8 md:w-8 m-auto cursor-pointer stroke-gray-500 hover:stroke-cyan-700 dark:stroke-gray-400 dark:hover:stroke-gray-300" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
      ...
      <div class="mx-1.5"
           ...
           @click="(selectedItems.length != 1) || emit('vf-rename', selectedItems)">
        <svg xmlns="http://www.w3.org/2000/svg"
             :class="(selectedItems.length == 1 && !selectedItems[0].readonly) ? 'cursor-pointer stroke-gray-500 hover:stroke-cyan-700 dark:stroke-gray-400 dark:hover:stroke-gray-300' : 'stroke-gray-200  dark:stroke-gray-700'"
      ...
      <div class="mx-1.5"
           ...
           @click="(!selectedItems.length) || emit('vf-delete', selectedItems)">
        <svg xmlns="http://www.w3.org/2000/svg"
             :class="(selectedItems.length && canDelete()) ? 'cursor-pointer stroke-gray-500 hover:stroke-cyan-700 dark:stroke-gray-400 dark:hover:stroke-gray-300' : 'stroke-gray-200  dark:stroke-gray-700'"
             class="h-6 w-6 md:h-8 md:w-8 m-auto" fill="none" viewBox="0 0 24 24" stroke="none" stroke-width="1.5">
      ...
      <div class="mx-1.5"
           ...
           @click="emit('vf-upload', selectedItems)">
...
const canDelete = () => {
  return !selectedItems.value.some(item => item.readonly);
}
